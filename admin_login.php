...
<body>
    ...
    <div id="full">
       <div id="inner_full">
        ...
        <div id="header"><h2>WELCOME ADMIN</h2></div>
        <div id="index" class="index">
            ...
            <div class="container">
              ...
              <div class="child">
                ...
                <input type="text" class="" name="mno" id="number">
              </div>
              <button type="submit" class="btn btn-primary" id="change" name="sub"><a href="home.php">Login</button>
